...
const Button = ({ children, variant = "default", size = "default", className = "", ...props }) => {
  ...
  const variants = {
    default: "bg-[#0047D9] text-white hover:bg-[#003BB8] shadow-lg hover:shadow-xl hover:scale-105",
    outline: "border-2 border-[#0047D9] text-[#0047D9] bg-white hover:bg-[#0047D9] hover:text-white hover:scale-105",
...
const rAIgineLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#features" className="text-slate-600 hover:text-[#0047D9] transition-colors font-medium">
                Features
              </a>
              <a href="#industries" className="text-slate-600 hover:text-[#0047D9] transition-colors font-medium">
                Industries
              </a>
              <a href="#demo" className="text-slate-600 hover:text-[#0047D9] transition-colors font-medium">
                Demo
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-600 mb-10 max-w-4xl mx-auto leading-relaxed">
              Control and automate desktop applications on your client machines remotely. Perfect for manufacturing,
              data entry, and desktop workflows.
            </p>
      ...
      {/* How It Works */}
      <section ref={workflowRef} className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div
            className={`text-center mb-16 transition-all duration-1000 ${workflowInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">How Remote Automation Works</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Connect once, automate forever. Control your client machines from our web platform.
            </p>
          </div>

          <div
            className={`grid md:grid-cols-3 gap-8 transition-all duration-1000 delay-300 ${workflowInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            {[
              {
                icon: Network,
                title: "1. Connect Client Machine",
                description: "Install our lightweight agent on employee laptops and desktop computers",
                color: "#0047D9",
              },
              {
                icon: MousePointer,
                title: "2. One-Click from Web",
                description: "Trigger automation scripts directly from our web platform with a single click",
                color: "#059669",
              },
              {
                icon: Cpu,
                title: "3. Execute on Remote PC",
                description: "Scripts run on the client machine, automating desktop apps and data entry tasks",
                color: "#DC2626",
              },
            ].map((step, index) => (
      ...
      <section ref={automationRef} className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div
            className={`text-center mb-16 transition-all duration-1000 ${automationInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">Live Automation Demo</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
          ...
          <div
            className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 delay-300 ${automationInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <div>
              <h3 className="text-3xl font-bold mb-6 text-slate-900">Manufacturing Data Entry Automation</h3>
              ...
              <Button onClick={startDemo} disabled={isAutomationRunning} size="lg" className="w-full sm:w-auto">
                {isAutomationRunning ? "Running Automation..." : "Start Live Demo"}
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-slate-900 rounded-lg p-4 border border-slate-300">
                    <div className="flex items-center space-x-2 mb-4">
                      ...
                      <span className="text-xs text-slate-300 ml-2">Manufacturing App v2.1</span>
                    </div>

                    <div className="space-y-3">
                      {automationSteps.slice(0, isAutomationRunning ? automationStep + 1 : 1).map((step, index) => (
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">Industries We Serve</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              From manufacturing to healthcare, we automate desktop workflows across industries
            </p>
          </div>
            ...
            {[
              {
                ...
                examples: ["Production data entry", "Inventory updates", "Quality reports"],
                color: "#0047D9",
              },
              {
                icon: FileText,
                ...
                examples: ["PDF from images", "Form automation", "Document scanning"],
                color: "#059669",
              },
              {
                icon: Database,
                ...
                examples: ["ERP data entry", "CRM updates", "Report generation"],
                color: "#DC2626",
              },
              {
                icon: BarChart3,
                title: "Financial Services",
                description: "Automate financial data processing, report generation, and compliance documentation",
                examples: ["Financial reports", "Compliance docs", "Data validation"],
                color: "#7C3AED",
              },
              {
                icon: Users,
                title: "HR & Administration",
                description: "Streamline employee onboarding, document processing, and administrative tasks",
                examples: ["Employee onboarding", "Document processing", "Time tracking"],
                color: "#EC4899",
              },
              {
                icon: Settings,
                title: "Custom Applications",
                description: "Automate any desktop application or legacy system with custom script development",
      ...
      <section ref={benefitsRef} className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#0047D9] to-[#003BB8]">
        <div className="max-w-7xl mx-auto">
          <div
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Why Choose rAIgine?</h2>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Enterprise-grade automation that transforms how your business operates
            </p>
          </div>

          <div
            className={`transition-all duration-1000 delay-300 ${benefitsInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            {/* Key Statistics */}
            <div className="grid md:grid-cols-4 gap-8 mb-16">
              {[
                { number: "500%", label: "Productivity Increase", icon: TrendingUp },
                { number: "24/7", label: "Automation Availability", icon: Clock },
                { number: "99.9%", label: "Execution Success Rate", icon: Award },
              ...
              {[
                {
                  ...
                  description: "Run automation scripts on remote machines instantly from our web platform",
                },
                {
                  icon: Monitor,
                  title: "Universal Compatibility",
                  description: "Control any desktop application - from legacy systems to modern software",
                },
                {
                  icon: Shield,
                  title: "Enterprise Security",
                  description: "Bank-grade encryption with full audit trails and compliance reporting",
                },
                {
                  icon: Network,
                  title: "Scalable Architecture",
                  description: "From single machines to thousands of endpoints, scales with your business",
                },
              ].map((benefit, index) => (
                <div
                  key={index}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 mb-8">
            Join manufacturing companies and businesses already automating with rAIgine
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg">
              Start Remote Automation
              <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
            <Button variant="outline" size="lg">
              Schedule Demo
          ...
          <p className="text-sm text-slate-500 mt-6">Quick setup • Secure connection • Works with any desktop app</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            {[
              {
                title: "Platform",
                links: ["Remote Automation", "Desktop Control", "Script Library", "Integrations"],
              },
              {
                title: "Industries",
                links: ["Manufacturing", "Healthcare", "Finance", "Retail"],
              },
              {
                title: "Support",
          ...
          <div className="border-t border-slate-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm">© 2025 rAIgine. All rights reserved.</p>
